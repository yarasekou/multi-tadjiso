 ...
 */
final class Version20251116193917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jaugeage ADD CONSTRAINT FK_2BBCDDF59FB71B08 FOREIGN KEY (cuve_id) REFERENCES cuves (id)');
    }
